...
\usepackage{colortbl}
\usepackage{footnote}
% Helvetica Neue (macOS system font; fallback to TeX Gyre Heros for Linux/CI)
% TeX Gyre Heros requires fontconfig registration; Helvetica Neue works out-of-the-box on macOS
\IfFontExistsTF{Helvetica Neue}{%
  \setmainfont{Helvetica Neue}%
  \setsansfont{Helvetica Neue}%
}{%
  \setmainfont{TeX Gyre Heros}[Path=/usr/local/texlive/2025/texmf-dist/fonts/opentype/public/tex-gyre/,Extension=.otf,UprightFont=texgyreheros-regular,BoldFont=texgyreheros-bold,ItalicFont=texgyreheros-italic,BoldItalicFont=texgyreheros-bolditalic]%
  \setsansfont{TeX Gyre Heros}[Path=/usr/local/texlive/2025/texmf-dist/fonts/opentype/public/tex-gyre/,Extension=.otf,UprightFont=texgyreheros-regular,BoldFont=texgyreheros-bold,ItalicFont=texgyreheros-italic,BoldItalicFont=texgyreheros-bolditalic]%
}
\usepackage{hyperref}
...
% Using simple environment instead of list to allow proper page breaks
...
\newenvironment{CSLReferences}[2]
  {\setlength{\parindent}{0pt}
   ...
   \sloppy  % Allow more flexible line breaks for URLs
   \emergencystretch=3em  % Extra stretch to avoid overfull boxes
   \everypar{\hangindent=\cslhangindent}}
  {\par}
